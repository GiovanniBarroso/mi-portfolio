  ...
  >
    <div class="container flex h-16 items-center justify-between">
      <RouterLink to="/" class="flex items-center gap-2 font-extrabold text-xl">
        ...
        ></span>
        <span class="text-zinc-900 dark:text-white">Mi Portfolio</span>
      </RouterLink>

      <!-- Desktop menu -->
      <ul class="hidden md:flex items-center gap-6 font-medium">
        <li>
          <RouterLink class="hover:text-brand-600" to="/">Inicio</RouterLink>
        </li>
        <li>
          <RouterLink class="hover:text-brand-600" to="/about"
            >Sobre mí</RouterLink
          >
        </li>
        <li>
          <RouterLink class="hover:text-brand-600" to="/projects"
            >Proyectos</RouterLink
          >
        </li>
        <li>
          <RouterLink class="hover:text-brand-600" to="/skills"
            >Skills</RouterLink
          >
        </li>
        <li>
          <RouterLink class="hover:text-brand-600" to="/contact"
            >Contacto</RouterLink
          >
        </li>
      </ul>
    ...
    <transition name="fade">
      ...
      >
        <ul class="container py-4 flex flex-col gap-3 font-medium">
          <li><RouterLink @click="close" to="/">Inicio</RouterLink></li>
          <li><RouterLink @click="close" to="/about">Sobre mí</RouterLink></li>
          <li>
            <RouterLink @click="close" to="/projects">Proyectos</RouterLink>
          </li>
          <li><RouterLink @click="close" to="/skills">Skills</RouterLink></li>
          <li>
            <RouterLink @click="close" to="/contact">Contacto</RouterLink>
          </li>
        </ul>
      </div>
    </transition>
